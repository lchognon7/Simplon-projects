...
--
-- Hôte : localhost
-- Généré le : ven. 02 avr. 2021 à 20:43
...
INSERT INTO `artists` (`artists_id`, `artist_name`) VALUES
(4, 'Dropkick Murphys'),
(5, 'Groove armada'),
(6, 'King Shiloh'),
(9, 'Crazy beaver'),
(20, 'Turntable Brothers'),
(21, 'Rammstein');
...
INSERT INTO `assoc_styles_artists` (`assoc_id`, `assoc_artist_id`, `assoc_style_id`) VALUES
(5, 5, 72),
(6, 6, 72),
(7, 6, 474),
(11, 5, 317),
...
--
ALTER TABLE `artists`
  MODIFY `artists_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT pour la table `assoc_styles_artists`
--
ALTER TABLE `assoc_styles_artists`
  MODIFY `assoc_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT pour la table `genres`
--
ALTER TABLE `genres`
  MODIFY `genre_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT pour la table `styles`
--
ALTER TABLE `styles`
  MODIFY `style_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=606;
...
--
ALTER TABLE `assoc_styles_artists`
  ADD CONSTRAINT `assoc_styles_artists_ibfk_1` FOREIGN KEY (`assoc_artist_id`) REFERENCES `artists` (`artists_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `assoc_styles_artists_ibfk_2` FOREIGN KEY (`assoc_style_id`) REFERENCES `styles` (`style_id`) ON DELETE CASCADE ON UPDATE CASCADE;
